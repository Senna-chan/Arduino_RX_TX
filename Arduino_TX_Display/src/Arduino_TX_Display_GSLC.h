...
gslc_tsElem                     m_asPage47Elem[MAX_ELEM_setModel_RAM];
gslc_tsElemRef                  m_asPage47ElemRef[MAX_ELEM_setModel];
...
gslc_tsXTogglebtn               m_asXToggle108;
gslc_tsXTogglebtn               m_asXToggle109;
gslc_tsXListbox                 m_sListbox3;
// - Note that XLISTBOX_BUF_OH_R is extra required per item
char                            m_acListboxBuf3[22 + XLISTBOX_BUF_OH_R];
gslc_tsXTogglebtn               m_asXToggle110;
gslc_tsXTogglebtn               m_asXToggle111;
gslc_tsXTogglebtn               m_asXToggle112;
gslc_tsXTogglebtn               m_asXToggle113;
gslc_tsXTogglebtn               m_asXToggle114;
gslc_tsXTogglebtn               m_asXToggle115;
gslc_tsXTogglebtn               m_asXToggle116;
gslc_tsXTogglebtn               m_asXToggle117;
...
extern gslc_tsElemRef* m_pCenteredstick;
extern gslc_tsElemRef* m_pDeadzone0;
extern gslc_tsElemRef* m_pDefaultval;
extern gslc_tsElemRef* m_pListSlider3;
...
//<InitGUI !Start!>
  ...
  gslc_PageAdd(&m_gui,setModel,m_asPage47Elem,MAX_ELEM_setModel_RAM,m_asPage47ElemRef,MAX_ELEM_setModel);
  ...
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,BTN_Quit,BasePage,
    (gslc_tsRect){280,0,35,18},(char*)"Quit",0,E_BUILTIN5X8,&CbBtnCommon);
  ...
  pElemRef = gslc_ElemXSliderCreate(&m_gui,deadzone0,calibrations,&m_sXSlider5,
  ...
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,reverse,setupChannel,&m_asXToggle108,
  ...
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,centeredStick,setupChannel,&m_asXToggle109,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,defaultval,setupChannel,(gslc_tsRect){230,138,40,20},
    (char*)m_sInputNumber25,7,E_BUILTIN5X8);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,pwmFreq,setupOutputPWM,(gslc_tsRect){160,60,40,20},
    (char*)m_sInputNumber26,7,E_BUILTIN5X8);
  gslc_ElemSetTxtMargin(&m_gui,pElemRef,5);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  gslc_ElemSetClickEn(&m_gui, pElemRef, true);
  gslc_ElemSetTouchFunc(&m_gui, pElemRef, &CbBtnCommon);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,stepMinFreq,setupOutputStepper,(gslc_tsRect){160,60,40,20},
    (char*)m_sInputNumber27,7,E_BUILTIN5X8);
  gslc_ElemSetTxtMargin(&m_gui,pElemRef,5);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  gslc_ElemSetClickEn(&m_gui, pElemRef, true);
  gslc_ElemSetTouchFunc(&m_gui, pElemRef, &CbBtnCommon);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,stepMaxFreq,setupOutputStepper,(gslc_tsRect){160,90,40,20},
    (char*)m_sInputNumber28,7,E_BUILTIN5X8);
  gslc_ElemSetTxtMargin(&m_gui,pElemRef,5);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  gslc_ElemSetClickEn(&m_gui, pElemRef, true);
  gslc_ElemSetTouchFunc(&m_gui, pElemRef, &CbBtnCommon);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,txt_ch1,setModel,(gslc_tsRect){11,42,19,10},
    (char*)"ch1",0,E_BUILTIN5X8);
  gslc_ElemSetHmiEvents(&m_gui,pElemRef, false, false, false, false);
  
  // Create toggle button sm0
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,sm0,setModel,&m_asXToggle110,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,txt_ch2,setModel,(gslc_tsRect){41,42,19,10},
    (char*)"ch2",0,E_BUILTIN5X8);
  gslc_ElemSetHmiEvents(&m_gui,pElemRef, false, false, false, false);
  
  // Create toggle button sm1
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,sm1,setModel,&m_asXToggle111,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,txt_ch3,setModel,(gslc_tsRect){71,42,19,10},
    (char*)"ch3",0,E_BUILTIN5X8);
  gslc_ElemSetHmiEvents(&m_gui,pElemRef, false, false, false, false);
  
  // Create toggle button sm2
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,sm2,setModel,&m_asXToggle112,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,txt_ch4,setModel,(gslc_tsRect){101,42,19,10},
    (char*)"ch4",0,E_BUILTIN5X8);
  gslc_ElemSetHmiEvents(&m_gui,pElemRef, false, false, false, false);
  
  // Create toggle button sm3
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,sm3,setModel,&m_asXToggle113,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,txt_ch5,setModel,(gslc_tsRect){131,42,19,10},
    (char*)"ch5",0,E_BUILTIN5X8);
  gslc_ElemSetHmiEvents(&m_gui,pElemRef, false, false, false, false);
  
  // Create toggle button sm4
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,sm4,setModel,&m_asXToggle114,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,txt_ch6,setModel,(gslc_tsRect){161,42,19,10},
    (char*)"ch6",0,E_BUILTIN5X8);
  gslc_ElemSetHmiEvents(&m_gui,pElemRef, false, false, false, false);
  
  // Create toggle button sm5
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,sm5,setModel,&m_asXToggle115,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,txt_ch7,setModel,(gslc_tsRect){191,42,19,10},
    (char*)"ch7",0,E_BUILTIN5X8);
  gslc_ElemSetHmiEvents(&m_gui,pElemRef, false, false, false, false);
  
  // Create toggle button sm6
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,sm6,setModel,&m_asXToggle116,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,txt_ch8,setModel,(gslc_tsRect){221,42,19,10},
    (char*)"ch8",0,E_BUILTIN5X8);
  gslc_ElemSetHmiEvents(&m_gui,pElemRef, false, false, false, false);
  
  // Create toggle button sm7
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,sm7,setModel,&m_asXToggle117,
