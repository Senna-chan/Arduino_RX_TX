...
/* Private variables ---------------------------------------------------------*/
SPI_HandleTypeDef *nRF_hspi = &hspi2;
UART_HandleTypeDef *nRF_uart = &huart1;

std::queue<char*> serialTXBuffer;

channelOutputConfig channelsOutputConfig[RC_MAX_CHANNELS + 1];
...
uint16_t channelValues[RC_MAX_CHANNELS];
...
void setDefault(uint8_t channelNumber){
    if(channelNumber == 0){
        ...
        setOutput(channelNumber, settings.model[settings.activeModel].channel_settings[channelNumber - 1].failsafe);
    }
}
...
void configureChannels(){
    ...
    setupChannelOutputConfigtt(3,&htim2, TIM_CHANNEL_3, &htim10.Instance->CCR1, &htim10, TIM_CHANNEL_1, CHSEL_STEP1_FF3_CH3_GPIO_Port, CHSEL_STEP1_FF3_CH3_Pin);
    setupChannelOutputConfigtt(4,&htim2, TIM_CHANNEL_4, &htim11.Instance->CCR1, &htim11, TIM_CHANNEL_1, CHSEL_STEP2_FF4_CH4_GPIO_Port, CHSEL_STEP2_FF4_CH4_Pin);
    ...
    setupChannelOutputConfigtt(7,&htim1, TIM_CHANNEL_2, &htim13.Instance->CCR1, &htim13, TIM_CHANNEL_1, CHSEL_STEP3_FF5_CH7_GPIO_Port, CHSEL_STEP3_FF5_CH7_Pin);
    setupChannelOutputConfigtt(8, &htim1, TIM_CHANNEL_3, &htim14.Instance->CCR1, &htim14, TIM_CHANNEL_1, CHSEL_STEP4_FF6_CH8_GPIO_Port, CHSEL_STEP4_FF6_CH8_Pin);

    setupChannelOutputConfigtt(9, &htim1, TIM_CHANNEL_4, &htim12.Instance->CCR1, &htim12, TIM_CHANNEL_1, CHSEL_FF1_1_CH9_GPIO_Port, CHSEL_FF1_1_CH9_Pin);
    setupChannelOutputConfigtt(10, &htim4, TIM_CHANNEL_1, &htim12.Instance->CCR2, &htim12, TIM_CHANNEL_2, CHSEL_FF1_2_CH10_GPIO_Port, CHSEL_FF1_2_CH10_Pin);
...
//  if (now % 1000 == 0) {
        ...
        bufPtr += sprintf(bufPtr, " RX %07d ERR %07d\r\n", txfailratio[0], txfailratio[1]);
        printf(buf);
    }
