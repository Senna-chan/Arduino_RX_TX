...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, SLEDB_Pin|SLEDG_Pin|SLEDR_Pin|CHSEL_DAC1_CH5_Pin
                          |CHSEL_DAC2_CH6_Pin|CHSEL_STEP3_FF5_CH7_Pin|CHSEL_STEP4_FF6_CH8_Pin|CHSEL_STEP1_FF3_CH3_Pin
                          |CHSEL_STEP2_FF4_CH4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, CHSEL_FF1_1_CH9_Pin|CHSEL_FF1_2_CH10_Pin|IO_DBG_1_Pin|IO_DBG_2_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = CHSEL_FF1_1_CH9_Pin|CHSEL_FF1_2_CH10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
